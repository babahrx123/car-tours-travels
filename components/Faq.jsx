            ...
            <div className="all-questions">
              <div className="faq-box">
                <div
                  ...
                  className={`faq-box__question  ${getClassQuestion("q1")}`}
                >
                  <p>1. What is special about comparing tour packages?</p>
                  <IoIosArrowDown />
                </div>
                <div
                  id="q1"
                  ...
                  className={`faq-box__answer ${getClassAnswer("q1")}`}
                >
                  Comparing tour packages is important as it helps find the best
                  deal that fits your budget and preferences, ensuring you get
                  the most value for your money. By comparing various options,
                  you can find packages that offer lower prices, additional
                  services, or better itineraries. You can find tour packages by
                  researching online and comparing prices from different travel
                  agencies.
                </div>
              </div>
              <div className="faq-box">
                <div
                  ...
                  className={`faq-box__question ${getClassQuestion("q2")}`}
                >
                  <p>2. How do I find the best tour deals?</p>
                  <IoIosArrowDown />
                </div>
                <div
                  id="q2"
                  ...
                  className={`faq-box__answer ${getClassAnswer("q2")}`}
                >
                  You can find the best tour deals by researching online and
                  comparing prices from different travel agencies. Websites such
                  as Expedia, Kayak, and Travelocity allow you to compare prices
                  and view available tour options. It is also recommended to
                  sign up for email newsletters and follow travel agencies on
                  social media to be informed of any special deals or
                  promotions.
                </div>
              </div>
              <div className="faq-box">
                <div
                  ...
                  className={`faq-box__question ${getClassQuestion("q3")}`}
                >
                  <p>3. How do I find such low tour prices?</p>
                  <IoIosArrowDown />
                </div>
                <div
                  id="q3"
                  ...
                  className={`faq-box__answer ${getClassAnswer("q3")}`}
                >
                  Book in advance: Booking your tour ahead of time can often
                  result in lower prices. Compare prices from multiple agencies:
                  Use websites like Kayak, Expedia, or Travelocity to compare
                  prices from multiple travel agencies. Look for discount codes
                  and coupons: Search for discount codes and coupons that you
                  can use to lower the tour price. Traveling during off-peak
                  seasons can sometimes result in lower prices.
                </div>
              </div>
            </div>
          </div>
